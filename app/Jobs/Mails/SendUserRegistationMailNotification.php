...
class SendUserRegistationMailNotification implements ShouldQueue
{
            ...
            if ($notification && $notification->mail == 1) {
                ...
                $notificationData = [
                    ...
                    'mail_body' => str_replace(
                        ['{name}', '{email}', '{mobile}'],
                        [$this->user->name, $this->user->email, $this->user->mobile],
                ...
                Mail::to($this->user->email)->send(new UserRegistationMail($this->user,$notificationData));
            }
        // }
