...
class SendReferralMailNotification implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;

    protected $auth_user;

    protected $reffered_user;
     ...
     * @return void
     */
    public function __construct($auth_user, $reffered_user)
    {
    ...
    public function handle()
    {
        ...
        $userLang = $this->reffered_user->lang ?? 'en';
        ...
        if (!$translation) {
            ...
            'mail_body' => str_replace('{name}', $this->auth_user->name, $translation->mail_body ?? $notification->mail_body),
        ...
        // Send welcome email
            Mail::to($this->auth_user->email)->send(new ReferralMail($this->auth_user, $notificationData));
    }
