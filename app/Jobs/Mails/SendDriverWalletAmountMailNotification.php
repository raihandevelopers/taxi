...
class SendDriverWalletAmountMailNotification implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct($driver, $transaction_id = null, $currency = null, $amount = null, $driver_wallet = null)
    {
        $this->driver = $driver; 
        ...
        // if(!empty($driver?->email)){
            ...
            $notificationData = [
                ...
                'mail_body' => str_replace(['{name}', '{transaction_id}','{currency}', '{amount}', '{current_balance}'],
                              [$this->driver->name, $this->transaction_id,$this->currency, $this->amount, $this->driver_wallet->amount_balance], 
                ...
                // Send welcome email
                Mail::to($this->driver->email)->send(new DriverWalletAddAmountMail($this->driver, $notificationData));
            }
        // }
