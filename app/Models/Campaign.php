...
class Campaign extends Model
{
     ...
     */
    protected $fillable = [
         'title','url','image','store_id','menu_item_id','banner_type','service_location_id','status','from_date','to_date','from_time','to_time'
    ];
    /**
    ...
    {
        return config('base.campaign.upload.images.path');
    }
