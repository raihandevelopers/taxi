    ...
    setup(props) {
        ...
        const deleteData = async (dataId) => {
            try {
                ...
                modalShow.value = false;
                Swal.fire('Success', t('delivery_cancellation_ride_deleted_successfully'), 'success');
            } catch (error) {
                Swal.fire(t('error'), t('failed_to_delete_delivery_cancellation_ride'), 'error');
            }
        };
        ...
        const fetchDatas = async (page = 1) => {
            try {
                ...
                console.error(t('error_fetching_delivery_cancellation_ride'), error);
            }
        };
...
<template>
    <Layout>
        ...
        <Head title="Delivery Cancellation Rides" />
        <PageHeader :title="$t('delivery_cancellation_ride')" :pageTitle="$t('delivery_cancellation_ride')" />
        <BRow>
            <BCol lg="12">
                            ...
                            <table class="table align-middle position-relative table-nowrap">
                                <thead class="table-active">
                                    <tr>
                                        ...
                                        <th scope="col"> {{$t("cancellation_by")}}</th>
                                        <th scope="col"> {{$t("cancellation_reason")}}</th>
                                        <th scope="col"> {{$t("cancellation_fee")}}</th>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">                                                    
                                                    <Link class="dropdown-item" href="/delivery-cancellation-rides/view"><i class=" bx bx-show-alt align-center text-muted me-2"></i>  {{$t("view")}}</Link>
                                                </ul>
                                            </div>
                                        </td>
                                     </tr>
