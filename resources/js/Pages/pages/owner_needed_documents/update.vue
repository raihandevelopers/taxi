...
<template>
    <Layout>
        ...
        <PageHeader :title="$t('update')" :pageTitle="$t(owner_needed_documents)" />
        <BRow>
            <BCol lg="12">
                        ...
                        <form action="javascript:void(0);">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select id="has_expiry_date" class="form-select" >
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select id="has_identify_number" class="form-select"  v-model="has_identify_number">
                                        <option disabled value=""> {{$t("select")}}</option>
                                        <option  value="1"> {{$t("yes")}}</option>
                                        <option  value="0"> {{$t("no")}} </option>
                                    </select>
                                ...
                                <div class="col-sm-6" v-show="has_identify_number === '1'">
                                    <div class="mb-3">
                                    <label for="identify_number_key" class="form-label"> {{$t("identify_number_key")}}</label>
                                    <input type="text" class="form-control" :placeholder="$t('enter_identify_number_key')" id="identify_number_key" 
                                    />
                                    <span v-for="(error, index) in errors.name" :key="index" class="text-danger">{{ error }}</span>
                                    </div>
                                </div>
