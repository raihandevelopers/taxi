...
if (etaParam.pick_lat && etaParam.drop_lat) {
drawRoute();
}
});
};
...
const min_trip_start_time = ref(null);
const min_return_time = ref(null);
...
etaParam.duration = Math.round((totalDuration) / 60);
...
<div class="text-center mt-2 amount">{{ vehicleType.total }}</div>
...
<h4 class="card-title mb-0 flex-grow-1"><i class="ri-dashboard-2-line mx-2"></i>8km</h4>
<h4 class="card-title mb-0 flex-grow-1"><i class="ri-dashboard-2-line mx-2"></i>15mins</h4>
<div class="flex-shrink-0">
<h4 class="card-title mb-0 flex-grow-1"><i class="bx bx-wallet mx-2"></i>$20</h4>
</div>
</div> -->
