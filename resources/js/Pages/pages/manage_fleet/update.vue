...
<template>
    <Layout>
        ...
        <PageHeader title="Update" pageTitle="Manage Fleet" />
        <BRow>
            <BCol lg="12">
                        ...
                        <form action="javascript:void(0);">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <select id="select_type" class="form-select" v-model="form.goods_type_for">
                                    ...
                                    <span v-for="(error, index) in errors.goods_type_for" :key="index" class="text-danger">{{ error }}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                    <label for="car_brand" class="form-label">Car Brand</label>
                                    <select id="car_brand" class="form-select" v-model="form.goods_type_for">
                                        <option disabled value="">Select</option>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select id="car_model" class="form-select" v-model="form.goods_type_for">
                                        <option disabled value="">Select</option>
                                        <option value="124_spider">124 Spider</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter License Plate Number" id="license_plate_number"/>
