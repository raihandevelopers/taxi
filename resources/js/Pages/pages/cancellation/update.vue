...
<template>
    <Layout>
        ...
        <PageHeader title="Update" pageTitle="Cancellation" />
        <BRow>
            <BCol lg="12">
                        ...
                        <form action="javascript:void(0);">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <select id="select_user_type" class="form-select" >
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                    <label for="select_payment_type" class="form-label">Payment Type</label>
                                    <select id="select_payment_type" class="form-select" >
                                        <option disabled value="">Select</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                    <label for="select_arrival_status" class="form-label">arrival Status</label>
                                    <select id="select_arrival_status" class="form-select" >
                                        <option disabled value="">Select</option>
