...
<template>
    <Layout>
        ...
        <PageHeader title="Update" pageTitle="Pending Drivers" />
        <BRow>
            <BCol lg="12">
                        ...
                        <form action="javascript:void(0);">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <select id="select_area" class="form-select" >
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select id="select_gender" class="form-select" >
                                        <option disabled value="">Select</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                    <label for="select_transport_type" class="form-label">Transport Type</label>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                    <label for="select_make_car" class="form-label">Make Car</label>
                                    <select id="select_make_car" class="form-select" >
                                        <option disabled value="">Select</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                    <label for="select_car_model" class="form-label">Car Model</label>
                                    <select id="select_car_model" class="form-select" >
                                        <option disabled value="">Select</option>
                                        <option  value="lcv_truck">LCV truck</option>
                                        <option  value="light_truck">light truck</option>
                                        <option  value="yodha_pcik_up">Yodha pick-up</option>
                                    </select>
                                    <span v-for="(error, index) in errors.country" :key="index" class="text-danger">{{ error }}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Car Color" id="car_color" 
                                    />
                                    <span v-for="(error, index) in errors.name" :key="index" class="text-danger">{{ error }}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Car Number" id="car_number" 
                                    />
                                    <span v-for="(error, index) in errors.name" :key="index" class="text-danger">{{ error }}</span>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-3">
                                    <label for="icon" class="form-label d-flex">Profile 
