                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">                                                    
                                                    <Link class="dropdown-item" href="#"><i class=" bx bxs-file-image align-center text-muted me-2"></i> {{$t("view_image")}}</Link>
                                                    <Link class="dropdown-item" href="/delete-request-drivers/document-upolad"><i class=" bx bx-upload align-center text-muted me-2"></i> {{$t("upload")}}</Link>
                                                    <a class="dropdown-item" href="#" @click.prevent="editData(result)"><i class="bx bxs-edit-alt align-center text-muted me-2"></i>{{$t("edit")}}</a>
