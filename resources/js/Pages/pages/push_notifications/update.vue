...
<template>
    <Layout>
        ...
        <PageHeader :title="$t('update')" :pageTitle="$t('push_notification')" />
        <BRow>
            <BCol lg="12">
                    ...
                    <BCardBody class="border border-dashed border-end-0 border-start-0">
                        <form action="javascript:void(0);">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                    <label for="select_area" class="form-label">{{$t("service_location")}}</label>
                                    <select id="select_area" class="form-select" >
                                        <option disabled value="">{{$t("select_service_location")}}</option>
                                        <option  value="chitwan">Chitwan</option>
                                        <option  value="katari">Katari</option>
                                        <option  value="trigger">trigger</option>
                                        <option  value="india">India</option>
                                        <option  value="nepal_delivery">Nepal Delivery</option>
                                        <option  value="new_york">New York</option>
                                        <option  value="nawalparasi">Nawalparasi</option>
                                        <option  value="trigger_2">TRIGGER 2</option>
                                        <option  value="kathmandu">Kathmandu</option>
                                        <option  value="uk_test">UK test</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                    <label for="select_send_to" class="form-label">{{$t("send_to")}}</label>
                                    <select id="select_send_to" class="form-select" >
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                    <label for="push_title" class="form-label">{{$t("push_title")}}</label>
                                    <input type="text" class="form-control" :placeholder="$t('enter_psuh_title')" id="push_title" 
                                    />
