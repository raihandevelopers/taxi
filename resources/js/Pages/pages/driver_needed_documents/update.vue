...
<template>
    <Layout>
        ...
        <Head title="Drivers Needed Documents" />
        <PageHeader title="Update" pageTitle="Drivers Needed Documents" />
        <BRow>
            <BCol lg="12">
                    ...
                    <BCardBody class="border border-dashed border-end-0 border-start-0">
                        <form action="javascript:void(0);">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                    <label for="account_type" class="form-label">{{$t("account_type")}}</label>
