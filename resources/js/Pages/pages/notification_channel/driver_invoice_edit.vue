                                                      ...
                                                      <td bgcolor="#EEEEEE" style="padding: 20px 15px 0 15px">
                                                        <div align="center">
                                                          <table border="0" cellpadding="0" cellspacing="0" width="660">
                                                            <tbody>
                                                              <tr>
                                                                <td bgcolor="#ffffff" style="padding: 24px 14px 0 14px; border-top-left-radius: 4px; border-top-right-radius: 4px">
                                                                    ...
                                                                    <tbody>
                                                                      <tr>
                                                                        <td width="40%" align="left">
                                                                          <table>
                                                                            <tbody>
                                                                              <tr>
                                                                                <td style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; color: #707070; font-weight: normal; line-height: 16px">
                                                                            ...
                                                                            <tbody>
                                                                              <tr>
                                                                                <td align="right" style="padding: 0 0 5px 0">
                                                                                  <a href="https://evoj.com/" style="float: right" rel="noreferrer" target="_blank">
                                                                                    <img src="/storage/uploads/website/images/rest.png" alt="Logo" class="logo" style="display: flex; float: none; text-align: center; height: 23px;margin-top:20px;">                                                                          
                                                                                  </a>
                                                                                  <br>
                                                                                </td>
                                                                              </tr>
                                                                      ...
                                                                      <tr>
                                                                        <td style="color: #ffffff; line-height: 10px">
                                                                          <img src="/invoice/Invoice_White_line.png" style="width: 100%" class="CToWUd" />
                                                                        </td>
                                                                      </tr>
                                                                    </tbody>
                                                                  </table>
                                                              ...
                                                              <tr>
                                                                <td bgcolor="#ffffff" align="center" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 40px; font-weight: bold; color: #000000">
                                                                  <table>
                                                                    <tbody>
                                                                      <tr>
                                                                        <td style="padding-left: 15px">
                                                                          <table>
                                                                            <tbody>
                                                                              <tr>
                                                                                <td style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 20px; font-weight: bold; color: #000000; padding-right: 10px">
                                                              ...
                                                              <tr>
                                                                <td bgcolor="#ffffff" align="center" style="padding-right: 20px; padding-left: 20px; padding-bottom: 2px; font-family: Helvetica, 'Helvetica Neue', Arial, sans-serif; color: #777777">
                                                              ...
                                                              <tr>
                                                                ...
                                                                style="font-family: Helvetica, Helvetica Neue, Arial, sans-serif; font-size: 14px; word-spacing: -0.3px; color: #000000; padding-bottom: 0px; padding-top: 17px">
                                                                  Thanks for driving with us, {driver_name}
                                                                </td>
                                                              </tr>
                                                              <tr>
                                                                <td bgcolor="#ffffff" align="center"
                                                                                  ...
                                                                                  <tr>
                                                                                    <td style="padding: 0 0 0 0">
                                                                                      <table cellspacing="0" cellpadding="0" border="0"  width="100%">
                                                                                        <tbody>
                                                                                          <tr>
                                                                                            <td valign="top" style="border-bottom: 1px solid #eeeeee; padding-bottom: 12px; padding-left: 14px; padding-top: 5px">
                                                                                              <table cellpadding="0" cellspacing="0" border="0" width="100%" style="width: 100%" align="left">
                                                                                                <tbody>
                                                                                                  <tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                      <td align="left">
                                                                                                        <table>
                                                                                                          <tbody>
                                                                                                            <tr>
                                                                                                              <td align="left" style="font-family: Arial, Helvetica, 'Helvetica Neue', sans-serif; color: #707070; font-size: 14px">
                                                                                            ...
                                                                                            <tr>
                                                                                              <td align="left">
                                                                                                <table align="right">
                                                                                                  <tbody>
                                                                                                    <tr>
                                                                                                      <td style="font-family: Arial, Helvetica, 'Helvetica Neue', sans-serif; color: #707070; font-size: 14px">
