        ...
        function payWithPaystack(e) {
            ...
            let handler = PaystackPop.setup({
                ...
                callback: function(response){
                    ...
                    window.location.href = "{{ route('paystack.checkout') }}?amount={{ $amount }}&currency_code={{ $currency_code }}&payment_for={{ $payment_for }}&user_id={{ $user_id }}&plan_id={{ $plan_id }}&request_id={{ $request_id }}";
                }
            });
            handler.openIframe();
        }
